  ...
  return (
    <div className="w-4/5 m-auto mt-8 p-6 bg-white flex flex-col lg:flex-row rounded-2xl shadow-md mb-4">
      <div className="lg:w-3/5 m-4">
        <h1 className="text-3xl font-bold mb-6 text-center lg:text-left text-primary">
          Understanding the CDP Mechanism
        </h1>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-primary">How the Contracts Work</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-primary">The Mechanism of Depositing and Minting</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-primary mb-4">Using Your Stablecoins</h2>
          <p className="text-lg text-primary mb-4">
            Once you have minted your stablecoins, you can use them in various ways:
          </p>
          <ul className="list-disc text-primary list-inside">
