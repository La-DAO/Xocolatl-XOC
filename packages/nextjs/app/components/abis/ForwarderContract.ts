export const forwarderABI = [
  ...
  { inputs: [{ internalType: "uint256", name: "_code", type: "uint256" }], name: "APP_RULE", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "flowOperator", type: "address" },
      { indexed: false, internalType: "uint8", name: "permissions", type: "uint8" },
      { indexed: false, internalType: "int96", name: "flowRateAllowance", type: "int96" },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "bool", name: "isCurrentlyPatricianPeriod", type: "bool" },
      { internalType: "uint256", name: "timestamp", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
