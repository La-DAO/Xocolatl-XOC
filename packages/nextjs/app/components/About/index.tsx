          ...
          <div className="flex flex-wrap items-center">
            ...
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical m-20">
              ...
              <li>
                ...
                <div className="timeline-middle">{/* SVG icon */}</div>
                <div className="timeline-end mb-10">
                  <time className="font-mono italic">{t("timelineDate6")}</time>
                  <div className="text-lg font-black">{t("timelineTitle6")}</div>
                  {t("timelineDesc6")}
                </div>
                <hr />
              </li>
              ...
              <li>
                ...
                <div className="timeline-middle">{/* SVG icon */}</div>
                <div className="timeline-end mb-10">
                  <time className="font-mono italic">{t("timelineDate8")}</time>
                  <div className="text-lg font-black">{t("timelineTitle8")}</div>
                  {t("timelineDesc8")}
                </div>
              </li>
            </ul>
