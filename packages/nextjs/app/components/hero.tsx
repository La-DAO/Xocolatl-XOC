      ...
      <Container className="flex flex-wrap bg-base-200">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl m-12 text-justify leading-snug tracking-tighter">
            <h1 className="text-4xl text-base-300 font-bold leading-snug tracking-tight lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-inherit">
              Mexico&rsquo;s MXN
              <br /> Stablecoin: XOC
            </h1>
            <p className="py-5 text-xl leading-normal text-base-300 lg:text-xl dark:text-inherit">
            ...
            <div className="my-8">
              <h2 className="text-2xl text-base-300 font-bold dark:text-inherit">About the name</h2>
              <p className="text-lg text-base-300 leading-normal dark:text-inherit">
